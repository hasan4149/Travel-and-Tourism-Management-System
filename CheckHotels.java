...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text = new String[] { "Grand Sylhet","Hotel Noorjahan Grand","Holy Inn","The Grand","Jatra","Hotel Star Pacific","Rose View Hotel","Grand Palace","La Vista Hotel","Nirvana Inn" };
        try {
            for(int i=0;i<=9;i++)
            {
